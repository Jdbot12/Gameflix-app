...
import org.example.demospring.repository.CourseRepository;
import org.example.demospring.repository.StudentRepository;
import org.example.demospring.service.CourseService;
import org.example.demospring.service.StudentService;
...
public class StudentController {
    ...
    @GetMapping("/showStudentFormForUpdate/{sid}")
    public String showStudentFormForUpdate(@PathVariable(value = "sid") long sid, Model model) {
